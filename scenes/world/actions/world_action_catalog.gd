...
const DEFINITIONS := {
	...
	WorldActionRecord.ActionType.SPELL_CAST: {KEY_IS_EXTERNAL: true, KEY_IS_TURN_BOUND: true, KEY_REQUIRES_ACTIVE_PLAYER: true, KEY_REQUIRES_PROFILE_PAYLOAD: true, KEY_REQUIRES_TURN_PROFILE_IN_TURN_MODE: true, KEY_PROFILE_CHANNEL: ProfileChannel.SPELL},
	...
	WorldActionRecord.ActionType.CHARACTER_ABILITY: {KEY_IS_EXTERNAL: true, KEY_IS_TURN_BOUND: true, KEY_REQUIRES_PROFILE_PAYLOAD: true, KEY_PROFILE_CHANNEL: ProfileChannel.ABILITY},
}
