...
const STATUS_MESSAGES := {
	...
	"map_sync_timeout": "Карта не была получена вовремя.",
	"map_invalid": "Host отправил некорректное описание карты.",
	"map_too_large": "Описание карты превышает сетевой лимит.",
	"map_build_failed": "Не удалось построить карту.",
}
